...
class ScatterChart extends PureComponent<Props, State> {
  ...
  updateChart(data, { w, h, m, x, y }) {
    ...
    /** Scatter setup. */
    root.append('g').attr('class', 'scatter-points');
    ...
    eventDispatcher.on('scatterClick', () => {});
    eventDispatcher.on('scatterMouseOver', () => {});
    eventDispatcher.on('scatterMouseOut', () => {});
  }
